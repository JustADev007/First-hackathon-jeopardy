...
document.querySelector(".player1-name").innerText = prompt(
  "Enter Playe1 Name",
  "type here",
);
document.querySelector(".player2-name").innerText = prompt(
  "Enter Playe2 Name",
  "type here",
);

document
  .querySelector(".card-easy")
  .addEventListener("click", openEasyQuestion);
